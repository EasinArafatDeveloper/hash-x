  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="fixed inset-0 bg-gray-900/50 dark:bg-black/70 backdrop-blur-sm"
      />
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-lg bg-white dark:bg-[#111113] rounded-xl border border-gray-200 dark:border-white/10 shadow-xl overflow-hidden flex flex-col"
      >
        {/* Header Bar */}
        ...
        <div className="p-5 sm:p-6 space-y-4 text-xs">
          {!isDeleting ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-rose-50/70 dark:bg-rose-500/5 border border-rose-200/80 dark:border-rose-900/60 space-y-2">
              ...
              <div className="p-3.5 rounded-xl bg-amber-50/80 dark:bg-amber-500/5 border border-amber-200 dark:border-amber-900/60 flex items-start gap-3">
            ...
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                {/* Metric 1: Elapsed */}
                <div className="p-2.5 rounded-xl bg-gray-50 dark:bg-white/[0.03] border border-gray-200/80 dark:border-white/10 flex items-center gap-2.5">
                ...
                <div className="p-2.5 rounded-xl bg-gray-50 dark:bg-white/[0.03] border border-gray-200/80 dark:border-white/10 flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-lg bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400 flex items-center justify-center shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="text-xs font-mono font-bold text-violet-600 dark:text-violet-400 truncate block">
              ...
              <div className="rounded-xl border border-gray-800 bg-[#0b0d10] text-slate-200 font-mono overflow-hidden">
                <div className="px-3 py-2 bg-[#111418] border-b border-gray-800 flex items-center justify-between text-[10px] text-slate-400">
                  <div className="flex items-center gap-2 font-bold">
                    <Terminal className="w-3 h-3 text-rose-400" />
                    <span>PURGE TELEMETRY FEED</span>
                  </div>
                  <span className="px-1.5 py-0.5 rounded bg-rose-500/10 text-rose-300 font-bold border border-rose-900/60">
                    LIVE
                  </span>
                </div>
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-5 bg-gray-50 dark:bg-white/[0.02] border-t border-gray-100 dark:border-white/10 flex items-center justify-end gap-3">
          {!isDeleting ? (
            <>
              <button
                type="button"
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs shadow-card flex items-center gap-2 transition-colors active:scale-[0.98] cursor-pointer"
              >
