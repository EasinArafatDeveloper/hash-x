...
export function Header({ onMobileMenuOpen, isCollapsed, onToggleCollapse, onOpenAiCopilot }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-20 h-14 bg-white/95 dark:bg-[#0A0A0B]/95 backdrop-blur-md border-b border-gray-200 dark:border-white/10 px-4 lg:px-6 flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        ...
        <div className="relative" ref={notifRef}>
          ...
          >
            ...
            {!notifRead && (
              <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-brand-600 rounded-full ring-2 ring-white dark:ring-[#0A0A0B]" aria-hidden="true" />
            )}
          </button>

          {showNotifications && (
            <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-[#111113] border border-gray-200 dark:border-white/10 rounded-xl shadow-cardHover z-50 overflow-hidden">
